...
namespace System.Runtime.Serialization.Generated
{
    ...
    public static partial class DataContractSerializerHelper
    {
        ...
        static int[] s_xmlDictionaryStrings = new int[] {
                ...
                -1, // string: null
                1, // array length: 1
                267, // index: 267, string: "http://schemas.datacontract.org/2004/07/Invaders.Uwp.Model"
                5, // array length: 5
                399, // index: 399, string: "DiedTime"
                408, // index: 408, string: "HighestScore"
                421, // index: 421, string: "KilledInvaders"
                436, // index: 436, string: "PlayedGames"
                448, // index: 448, string: "PlayedTime"
                5, // array length: 5
                267, // index: 267, string: "http://schemas.datacontract.org/2004/07/Invaders.Uwp.Model"
                267, // index: 267, string: "http://schemas.datacontract.org/2004/07/Invaders.Uwp.Model"
                267, // index: 267, string: "http://schemas.datacontract.org/2004/07/Invaders.Uwp.Model"
        ...
        static readonly global::DataContractMapEntry[] s_dataContractMap = new global::DataContractMapEntry[] {
                ...
                new global::DataContractMapEntry() {
                    UserCodeType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("Invaders.Uwp.Model.HistoryData, Invaders.Uwp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")),
                    TableIndex = 1, // 0x1
                }, 
                new global::DataContractMapEntry() {
                    UserCodeType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("System.Object[], System.Private.CoreLib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")),
        ...
        static readonly global::ClassDataContractEntry[] s_classDataContracts = new global::ClassDataContractEntry[] {
                new global::ClassDataContractEntry() {
                    Common = new global::CommonContractEntry() {
                        HasRoot = true,
                        NameIndex = 255, // HistoryData
                        NamespaceIndex = 267, // http://schemas.datacontract.org/2004/07/Invaders.Uwp.Model
                        StableNameIndex = 255, // HistoryData
                        StableNameNamespaceIndex = 267, // http://schemas.datacontract.org/2004/07/Invaders.Uwp.Model
                        TopLevelElementNameIndex = 255, // HistoryData
                        TopLevelElementNamespaceIndex = 267, // http://schemas.datacontract.org/2004/07/Invaders.Uwp.Model
                        OriginalUnderlyingType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("Invaders.Uwp.Model.HistoryData, Invaders.Uwp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")),
                        UnderlyingType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("Invaders.Uwp.Model.HistoryData, Invaders.Uwp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")),
                    },
        ...
        static readonly global::CollectionDataContractEntry[] s_collectionDataContracts = new global::CollectionDataContractEntry[] {
                new global::CollectionDataContractEntry() {
                    Common = new global::CommonContractEntry() {
                        HasRoot = true,
                        NameIndex = 326, // ArrayOfanyType
                        NamespaceIndex = 341, // http://schemas.microsoft.com/2003/10/Serialization/Arrays
                        StableNameIndex = 326, // ArrayOfanyType
                        StableNameNamespaceIndex = 341, // http://schemas.microsoft.com/2003/10/Serialization/Arrays
                        TopLevelElementNameIndex = 326, // ArrayOfanyType
                        TopLevelElementNamespaceIndex = 341, // http://schemas.microsoft.com/2003/10/Serialization/Arrays
                        OriginalUnderlyingType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("System.Object[], System.Private.CoreLib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")),
                        UnderlyingType = new global::Internal.Runtime.CompilerServices.FixupRuntimeTypeHandle(global::System.Runtime.InteropServices.TypeOfHelper.RuntimeTypeHandleOf("System.Object[], System.Private.CoreLib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")),
                    },
        ...
        static readonly global::JsonDelegateEntry[] s_jsonDelegatesList = new global::JsonDelegateEntry[] {
                new global::JsonDelegateEntry() {
                    ...
                    WriterDelegate = global::SgIntrinsics.AddrOf<global::System.Runtime.Serialization.Json.JsonFormatClassWriterDelegate>(global::Type3.WriteHistoryDataToJson),
                    ReaderDelegate = global::SgIntrinsics.AddrOf<global::System.Runtime.Serialization.Json.JsonFormatClassReaderDelegate>(global::Type2.ReadHistoryDataFromJson),
                }, 
                new global::JsonDelegateEntry() {
        ...
        static char[] s_stringPool = new char[] {
            ...
            'e','d','S','h','o','r','t','\0','a','n','y','U','R','I','\0','H','i','s','t','o','r','y','D','a','t','a','\0','h','t','t',
            'p',':','/','/','s','c','h','e','m','a','s','.','d','a','t','a','c','o','n','t','r','a','c','t','.','o','r','g','/','2',
            '0','0','4','/','0','7','/','I','n','v','a','d','e','r','s','.','U','w','p','.','M','o','d','e','l','\0','A','r','r','a',
            'y','O','f','a','n','y','T','y','p','e','\0','h','t','t','p',':','/','/','s','c','h','e','m','a','s','.','m','i','c','r',
            'o','s','o','f','t','.','c','o','m','/','2','0','0','3','/','1','0','/','S','e','r','i','a','l','i','z','a','t','i','o',
            'n','/','A','r','r','a','y','s','\0','D','i','e','d','T','i','m','e','\0','H','i','g','h','e','s','t','S','c','o','r','e',
            '\0','K','i','l','l','e','d','I','n','v','a','d','e','r','s','\0','P','l','a','y','e','d','G','a','m','e','s','\0','P','l',
            'a','y','e','d','T','i','m','e','\0'};
    }
}
